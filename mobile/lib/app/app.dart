  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        DigitalTwinDashboardScreen.routeName: (_) => const DigitalTwinDashboardScreen(),
        ...
        NotificationCenterScreen.routeName: (_) => const NotificationCenterScreen(),
        ApplicationSettingsScreen.routeName: (_) => const ApplicationSettingsScreen(),
        OfflineDashboardScreen.routeName: (_) => const OfflineDashboardScreen(),
        MonitoringDashboardScreen.routeName: (_) => const MonitoringDashboardScreen(),
      },
    );
  }
}
